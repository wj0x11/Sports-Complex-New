...
function SportDetails() {
  ...
  const sport = sportsData.find((item) => item.slug === sportSlug);
  ...
  const availableSlots = useMemo(() => {
    if (!sport || !selectedDate || isTableTennis) return [];
  ...
  const handleContinue = () => {
    ...
    if (!selectedCourt) {
      alert("Please select a badminton court.");
      ...
      <div className="container">
          ...
          <div className="timetable-section">
            <div className="section-header">
              <div>
                ...
                <h2 className="details-title">Badminton Timetable</h2>
              </div>
            </div>
        ...
        {!isTableTennis && (
          <div className="details-section">
            <div className="section-header">
              <div>
                <span className="section-badge">Badminton Facilities</span>
