...
function Dashboard() {
  ...
  // initialize loading based on whether we already have an authenticated user
  const [loading, setLoading] = useState(() => !!authUser?.email);
  ...
  useEffect(() => {
    ...
    apiClient
      .getDashboardData(authUser.email)
      .then((data) => {
      ...
      <main className="dashboard-main">
        ...
        <div className="dashboard-header">
          <div>
            ...
            {loading && <p className="dashboard-subtitle">Syncing live data...</p>}
          </div>
        </div>
